...
- A token is an authorization header that gives access to protected resources.

- [ ] What steps can you take in your web apps to keep your data secure?

- Use protected routes and authentication protocols

- [ ] Describe how web servers work.

- Servers hold information and resources that it sends info to and from end users and the internet. Us > server > info > server > us
